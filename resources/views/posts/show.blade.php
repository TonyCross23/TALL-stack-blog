<x-app-layout title="Details Page">
            <article class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 w-full" style="max-width:700px">
                ...
                <div class="mt-2 flex justify-between items-center">
                    <div class="flex py-5 text-base items-center">
                        <img class="w-11 h-11 rounded-full mr-3" src="{{$post->author->profile_photo_url}}"
                            alt="avatar">
                ...
                <div class="flex items-center space-x-4 mt-10">
                    ...
                    <x-badge wire:navigate href="{{route('posts.index',['category' => $category->title])}}" :textColor="$category->text_color" :bgColor="$category->bg_color">{{$category->title}}</x-badge>
                     @endforeach
                </div>
